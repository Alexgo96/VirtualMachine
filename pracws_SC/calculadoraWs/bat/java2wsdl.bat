...
rem echo Path...
rem SET PATH=%path%;%JAVA_HOME%\bin;%AXIS2_HOME%\bin;%ANT_HOME%\bin
...
echo AXIS2_CLASS_PATH: %AXIS2_CLASS_PATH%

set _RUNJAVA="%JAVA_HOME%\bin\java"
rem --pasar opciones desde consola %_RUNJAVA% %JAVA_OPTS% -cp "!AXIS2_CLASS_PATH!" org.apache.ws.java2wsdl.Java2WSDL %*
cd ../calculadora/bin

%_RUNJAVA% %JAVA_OPTS% -cp .;"!AXIS2_CLASS_PATH!" org.apache.ws.java2wsdl.Java2WSDL -o ../../wsdl/ -of calcu.wsdl -l "http://localhost:8080/axis2/services/Calculadora" -cn calculadora.Calculadora
