...
rem linea de comandos parametros %_RUNJAVA% %JAVA_OPTS% -cp "!AXIS2_CLASS_PATH!" org.apache.axis2.wsdl.WSDL2Java %*
rem %_RUNJAVA% %JAVA_OPTS% -cp "!AXIS2_CLASS_PATH!" org.apache.axis2.wsdl.WSDL2Java -uri ../wsdl/calcu.wsdl -d xmlbeans -p wscalcu -s -ss -sd -ssi   -o ../ws

%_RUNJAVA% %JAVA_OPTS% -cp "!AXIS2_CLASS_PATH!" org.apache.axis2.wsdl.WSDL2Java -uri ../wsdl/calcu.wsdl -d adb -ns2p http://calculadora=calculadora.ws  -t -s -ss -sd -ssi   -o ../servidor


rem -ns2p ns1=pkg1,ns2=pkg2  Specify a custom package name for each namespace spe, -p wscalcu
